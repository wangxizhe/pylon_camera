...
或者第二种安装办法
"mkdir -p pylon-5.2.0.13457-x86_64"  "cd pylon-5.2.0.13457-x86_64"  "git clone https://github.com/wangxizhe/pylon-5.2.0.13457-x86_64.git"  "sudo tar -C /opt -xzf pylonSDK*.tar.gz"  "./setup-usb.sh"  "cd"
